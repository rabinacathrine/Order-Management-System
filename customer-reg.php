...
<?php
	if(isset($_REQUEST['custmr']))
	{
		...
		$sl="insert into customer (C_UserName, C_PassWord, C_FName, C_LName, C_PANNo, C_Email, C_MoNo, C_Address, C_City, C_State) values('$us', '$wp', '$f', '$l', '$pn', '$em', '$mn', 		             '$a','$ci', '$s')";
		mysql_query($sl);
	}
?>
<!DOCTYPE html>
...
<head>
   ...
   <script type="text/javascript">
            ...
            function Validation()
            {
                ...
                var vusername = document.getElementById("c_usrn");
                var vfname = document.getElementById("c_fn");
				var vlname = document.getElementById("c_ln");
                var vpassword = document.getElementById("c_pass");
                var vpancardnumber = document.getElementById("c_cpan");
                var vemailaddress = document.getElementById("c_mail");
                var vmobileno = document.getElementById("c_cono");
                ...
                if(vpancardnumber.value == "")
                    {
                    alert("Enter your Pancard number ");
                    vpancardnumber.focus();
                    return false;
                    }
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Customer</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  <div class="widget box blue" id="form_wizard_1">
                     <div class="widget-title">
                        <h4>
                           <i class="icon-reorder"></i> Customer Registration <span class="step-title">Step 1 of 4</span>
                        </h4>
                        <span class="tools">
                        ...
                        <form action="#" class="form-horizontal" onSubmit="return Validation()">
                           <div class="form-wizard">
                              ...
                              <div class="tab-content">
                                 <div class="tab-pane active" id="tab1">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" class="span6" name="usr"id="c_usrn" />
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" class="span6" name="email" id="c_mail"/>
									...
									<div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="password" class="span6" name="psw" id="c_pass"/>
									...
									<div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" class="span6" name="pn" id="c_cpan" />
                                          <span class="help-inline">Give your PAN Card No</span>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="tab-pane" id="tab2">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" class="span6" name="fn" id="c_fn"/>
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" class="span6" name="ln" id="c_ln"/>
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" class="span6" name="cn" id="c_cono"/>
                                 ...
                                 <div class="tab-pane" id="tab3">
                                    ...
                                    <label class="control-label">Address</label>
                                    	<div class="controls">
                                        <textarea class="input-large" rows="3" name="add"></textarea>
                                    	</div>
                                	</div>
									<div class="control-group">
									...
									<div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" class="span6" name="state" />
                                          <span class="help-inline"></span>
                                       </div>
                                    </div>
                                 </div>
                              ...
                              <div class="form-actions clearfix">
                                 ...
                                 <input type="submit" class="btn btn-success button-submit" name="custmr">
