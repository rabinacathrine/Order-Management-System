...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <?php 
$ret = mysqli_query($con,"SELECT * FROM order_detail_user WHERE O_Id='$oid'");
...
while($row=mysqli_fetch_array($ret))
   ...
   <?php  }
$st='Delivered';
   $rt = mysqli_query($con,"SELECT * FROM order_detail_user WHERE O_Id='$oid'");
     while($num=mysqli_fetch_array($rt))
     {
     $currrentSt=$num['O_Status'];
   }
     if($st==$currrentSt)
     { ?>
   <tr><td colspan="2"><b>
