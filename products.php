...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item last" id="eight"><a href="" class="main current"><span class="outer"><span class="inner settings">Products</span></span></a></li>        
    </ul>
</div>
<!-- MENU END -->
</div>
    ...
    <!--THIS IS A WIDE PORTLET-->
		<div class="portlet">
			...
			<!--<a rel="facebox" href="addproduct.php">Add Product</a>-->
				<a href="admin_order.php">Place order</a>
			</div>
			...
			<form action="" method="post">
					...
					<table cellpadding="1" cellspacing="1" id="resultTable">
						...
						<?php
							...
							$result=mysql_query('SELECT * From addproduct');
							while($row =(mysql_fetch_array($result)))
								{
									echo '<tr class="record">';
									echo '<td style="border-left: 1px solid #C1DAD7;">'.$row['P_Name'].'</td>';
									//echo '<td style="border-left: 1px solid #C1DAD7;">'.$row['Cat_Name'].'</td>';
									//echo '<td style="border-left: 1px solid #C1DAD7;">'.$row['Scat_Name'].'</td>';
									echo '<td><div align="left">'.$row['PS_Price'].'</div></td>';
									echo '<td><div align="left">'.$row['P_Description'].'</div></td>';
									echo '<td><a rel="facebox" href="editproductimage.php?id='.$row['P_Id'].'"><img src="C:/wamp/www/order/project/oms/supplier/img/'.$row['P_Image'].'alt='.$row['P_Name'].'" width="80" height="50"></a></td>';
									echo '<td><div align="center"><a rel="facebox" href="editproductetails.php?id='.$row['P_Id'].'">edit</a> | <a href="#" id="'.$row['P_Id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
