...
<?php
	if(isset($_REQUEST['c_st']))
	{
		$st_id=$_REQUEST['c_st'];
		$sel_st=mysql_query("select * from customer where C_Id='$st_id'");
		$ft_st=mysql_fetch_array($sel_st);
		if($ft_st['C_status']=='enable')
		{
			$up_st=mysql_query("update customer set C_status='disable' where c_Id='$st_id'");
			header("location:customer_detail.php");
		}
		else
		{
			$up_st=mysql_query("update customer set C_status='enable' where C_Id='$st_id'");
			header("location:customer_detail.php");
		}
	}
?>
                  ...
                  <div class="widget">
                       <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-tags"></i> Product Detail List</h4>
                                        <span class="tools">
                                ...
                                <div class="widget-body">
								    ...
								    <table class="table table-striped table-bordered table-advance table-hover" border="1">
                                        <thead>
                                        <tr>
                                            <th><i class="icon-leaf"></i> <span class="hidden-phone">C_Id</span></th>
											<th><span>Customer Name</span></th>
											<th><span>Customer Email</span></th>
											 <th><i class="icon-user"></i> <span class="hidden-phone ">Customer Contact</span></th>
											 <th>Customer Address</th>
											<th><span>Customer City</span></th>
											<th><span>Customer State</span></th>
                                        ...
                                        <tbody>
										<?php 
											$sel_prod=mysql_query("select * from  customer  ");
											while($exe_prod=mysql_fetch_array($sel_prod))
											{
										?>
                                        <tr>
                                            <td >
                                                <div class="info"><?php echo $exe_prod['C_Id']; ?></div>
                                                
                                            </td>
											<td><a href="customer_p_detail.php?cnm=<?php echo $exe_prod['C_Id'];?>" ><?php echo $exe_prod['C_UserName']; ?></td>
											<td><?php echo $exe_prod['C_Email'];?></td>
											 <td><?php echo $exe_prod['C_MoNo']; ?></td>
											 <td><?php echo $exe_prod['C_Address'];?></td>
											<td><?php echo $exe_prod['C_City'];?></td>
											<td><?php echo $exe_prod['C_State'];?></td>
											<td><?php echo $exe_prod['C_PANNo'];?></td>
											<td><a href="customer_detail.php?c_st=<?php echo $exe_prod['C_Id'];?>" ><?php echo $exe_prod['C_status'];?></a></td>                                        											
