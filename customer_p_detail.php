               ...
               <div class="span12">
                  <div class="widget">
                       <div class="widget">
								...
								<?php
									if(isset($_REQUEST['cnm']))
									{
										$sup_id=$_REQUEST['cnm'];
										$sel_sup_d=mysql_query("select * from customer where C_Id='$sup_id'");
                                ...
                                <div class="widget-body">
								     ...
								     <table class="table table-striped table-bordered table-advance table-hover" border="1">
                                        ...
                                        <tr>
										 <th width="400px;">C_Id</th>
											 <td><?php echo $fet_sup_d['C_Id']; $f_id_s=$fet_sup_d['C_Id']; ?></td>
										</tr>
										<tr>
											<th>Customer Name</th>
											<td><?php echo $fet_sup_d['C_UserName']; ?></td>
										</tr>
										<tr>
											<th>Customer Email</th>
											<td><?php echo $fet_sup_d['C_Email']; ?></td>
										</tr>
										<tr>
                                            <th>Customer Contact</th>
											<td><?php echo $fet_sup_d['C_MoNo']; ?></td>
										</tr>
										<tr>
                                            <th>Customer Address</th>
											<td><?php echo $fet_sup_d['C_Address']; ?></td>
                                        </tr>
										<tr>
                                            <th>Customer City</th>
											<td><?php echo $fet_sup_d['C_City']; ?></td>
                                        </tr>
										<tr>
                                            <th>Customer PAN NO</th>
											<td><?php echo $fet_sup_d['C_PANNo']; ?></td>
                                        </tr>
										
										<tr>
                                            <th>Customer Status</th>
											<td><?php echo $fet_sup_d['C_status']; ?></td>
                                        </tr>
