...
header('location:index.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"update customer set C_UserName='$name',C_MoNo='$contactno' where C_Id='".$_SESSION['id']."'");
		if($query)
		{
...
{
$sql=mysqli_query($con,"SELECT C_PassWord FROM  customer where C_PassWord='".md5($_POST['cpass'])."' && C_Id='".$_SESSION['id']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update customer set C_PassWord='".md5($_POST['newpass'])."', updationDate='$currentTime' where C_Id='".$_SESSION['id']."'");
...
<div class="form-group">
					    ...
					    <input type="text" class="form-control unicase-form-control text-input" value="<?php echo $row['C_UserName'];?>" id="name" name="name" required="required">
					  </div>
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['C_Email'];?>" readonly>
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="Contact No.">Contact No. <span>*</span></label>
					    <input type="text" class="form-control unicase-form-control text-input" id="contactno" name="contactno" required="required" value="<?php echo $row['C_MoNo'];?>"  maxlength="10">
					  </div>
