...
<?php
	if(isset($_REQUEST['add_subc']))
	{
		$ins_cat=$_REQUEST['cat'];	
		$ins_subc=$_REQUEST['subcat'];
		$ins_subd=$_REQUEST['subcat_des'];
		
		$ins_sub_ins=mysql_query("insert into subcategory(Cat_Id,Scat_Name,Scat_description) value('$ins_cat','$ins_subc','$ins_subd')");
	}
?>
<!DOCTYPE html>
	...
	function vald()
            {
                ...
                var cat_name = document.getElementById("sub_cat");  
				
                if(cat_name.value=='')
                    {
                    alert("Please Enrter Sub-category...!");
                    cat_name.focus();
                    return false;
                }
                ...
                if(!usernamePatten.test(cat_name.value))
                    {
                    alert("Use Only Alphabate Charecter in Sub-Category");
                    cat_name.focus();
                    cat_name.value='';
                    return false;
                }                 	
                            ...
                            <form class="form-horizontal" method="post" onSubmit="return vald()">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
										...
										<?php
											$sel_subc=mysql_query("select * from category ");
											while($fet_subc=mysql_fetch_array($sel_subc))
											{
										?>
										<option value="<?php echo $fet_subc['Cat_Id'];?>"><?php echo $fet_subc['Cat_Name'];?></option>.
										<?php
											}
										?>
										</select>
								...
								<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="subcat" placeholder="sub-category" id="sub_cat" class="input-large" />
                                    </div>
                                </div>
								<div class="control-group">
                                    <label class="control-label">Sub-Category Description</label>
                                    <div class="controls">
                                        <textarea class="input-xxlarge" name="subcat_des" rows="3"></textarea>
                                    </div>
                                </div>
								
                                <div class="form-actions">
									<input type="submit" name="add_subc" value="SAVE"></input>
