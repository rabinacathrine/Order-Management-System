...
?>
<?php
$sel_ao=mysql_query("select * from adminorder ");
               ...
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
                           <a href="#">product Pages</a> <span class="divider">&nbsp;</span>
                       </li>
                       <li><a href="#">details Page</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                                ...
                                <div class="widget-body">
								   ...
								   <table class="table table-striped table-bordered table-advance table-hover" border="1">
                                        ...
                                        <tr>
										 ...
										 <th>P_Name</th>
										 <th>S_Name</th>
										 <th>Admin order Quantity</th>
										 <th>AO_Date</th>
										 <th>AO_Amount</th>
											 
										</tr>
										<?php
										while($fetch_ao=mysql_fetch_array($sel_ao))
										{
										$p_id=$fetch_ao['P_Id'];
										$s_id=$fetch_ao['S_Id'];
										
										$sel_pn=mysql_query("select * from addproduct where P_Id=$p_id ");
										$fetch_pn=mysql_fetch_array($sel_pn);
										
										$sel_sn=mysql_query("select * from supplier where S_Id=$s_id ");
										$fetch_sn=mysql_fetch_array($sel_sn);
										
										?>
										<tr>
											<td><?php echo $fetch_ao['AO_Id']; ?></td>
											<td><?php echo $fetch_pn['P_Name']; ?></td>
											<td><?php echo $fetch_sn['S_UserName']; ?></td>	
											<td><?php echo $fetch_ao['AO_Quantity']; ?></td>
											<td><?php echo $fetch_ao['AO_Date']; ?></td>
											<td><?php echo $fetch_ao['AO_Amount']; ?></td>					
										</tr>										
										<?php
										}
										?>
