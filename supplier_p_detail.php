...
<head>
   <meta charset="utf-8" />
   <title>Supplier Product detail</title>
               ...
               <div class="span12">
                  <div class="widget">
                       <div class="widget">
								...
								<?php
									if(isset($_REQUEST['snm']))
									{
										$sup_id=$_REQUEST['snm'];
										$sel_sup_d=mysql_query("select * from supplier where S_Id='$sup_id'");
										$fet_sup_d=mysql_fetch_array($sel_sup_d);
									}
								?>
                                <div class="widget-body">
								   ...
								   <table class="table table-striped table-bordered table-advance table-hover" border="1">
                                        ...
                                        <tr>
										 <th width="400px;">S_Id</th>
											 <td><?php echo $fet_sup_d['S_Id']; $f_id_s=$fet_sup_d['S_Id']; ?></td>
										</tr>
										<tr>
											<th>Supplier Name</th>
											<td><?php echo $fet_sup_d['S_UserName']; ?></td>
										</tr>
										<tr>
											<th>Supplier Email</th>
											<td><?php echo $fet_sup_d['S_Email']; ?></td>
										</tr>
										<tr>
                                            <th>Supplier Contact</th>
											<td><?php echo $fet_sup_d['S_MoNo']; ?></td>
										</tr>
										<tr>
                                            <th>Supplier Address</th>
											<td><?php echo $fet_sup_d['S_Address']; ?></td>
                                        </tr>
										<tr>
                                            <th>Supplier City</th>
											<td><?php echo $fet_sup_d['S_City']; ?></td>
                                        </tr>
										<tr>
                                            <th>Supplier State</th>
											<td><?php echo $fet_sup_d['S_State']; ?></td>
                                        </tr>
										<tr>
											...
											<?php
												$sel_p_s=mysql_query("select * from addproduct where S_Id='$f_id_s'");
												while($fet_p_s=mysql_fetch_array($sel_p_s))
												{
											?>
											<option><?php echo $fet_p_s['P_Name']; ?></option>
											<?php
												}
											?>
											</select>
										...
										<tr>
											...
											<td><?php echo $fet_sup_d['S_status']; ?></td>
                                        </tr>
