...
<?php
	if(isset($_REQUEST['pay_sts']))
		{
			
			$sts_id=$_REQUEST['pay_sts'];			
			$sel_ord=mysql_query("select Pay_Status from order_detail_user where Id='$sts_id' ");
			$fet_ord=mysql_fetch_array($sel_ord);
			if($fet_ord['Pay_Status']=='paid')
			{
				$up_sts=mysql_query("update order_detail_user set Pay_Status='not paid' where Id='$sts_id'");
				
			}
			else if($fet_ord['Pay_Status']=='not paid')
			{
				$up_sts=mysql_query("update order_detail_user set v='paid' where Id='$sts_id'");
				
			}
		}
		
		if(isset($_REQUEST['sts_ord']))
		{
			$sts_id=$_REQUEST['sts_ord'];			
			$sel_ord=mysql_query("select Order_Status from order_detail_user where Id='$sts_id' ");
			$fet_ord=mysql_fetch_array($sel_ord);
			if($fet_ord['Order_Status']=='pending')
			{
				$up_sts=mysql_query("update order_detail_user set Order_Status='conform' where Id='$sts_id'");
				
			}
			else if($fet_ord['Order_Status']=='conform')
			{
				$up_sts=mysql_query("update order_detail_user set Order_Status='pending' where Id='$sts_id'");
          ...
          <ul class="sidebar-menu">
				...
				<li class="has-sub">
					...
					<ul class="sub">
						...
						<li><a class="" href="customer_detail.php">Block Customer</a></li>						
					</ul>
				</li>
				<li class="has-sub">
					<a href="javascript:;" class="">
					...
					<ul class="sub">
						...
						<li><a class="" href="supplier_detail.php">Block Supplier</a></li>
				...
				<li class="has-sub">
					...
					<ul class="sub">
						...
						<li><a class="" href="admin_order.php"> Order</a></li>
               ...
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
                           <a href="#">Order details</a> <span class="divider">&nbsp;</span>
                       </li>
                  ...
                  <div class="widget">
                       <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-tags"></i> Order Detail List</h4>
                                        <span class="tools">
                                ...
                                <div class="widget-body">
                                     <form method="post">
								    <table class="table table-striped table-bordered table-advance table-hover" border="0">
                                        <thead>
                                        <tr>
                                            <!--<th><i class="icon-leaf"></i> <span class="hidden-phone">From</span></th>-->
											<th><span>Oreder Id</span></th>
											<th><span>product</span></th>
											<th><span>Product price</span></th>
											<th><span>Quantity</span></th>
                                            <th><i class="icon-user"></i> <span class="hidden-phone ">User Name</span></th>
                                            <th><i class="icon-tags"> </i><span class="hidden-phone">Amount/Status</span></th>
											<th><span class="hidden-phone">Order Status</span></th>
                                            <th>Address</th>
                                        ...
                                        <tbody>
										<?php 
											$sel_ord=mysql_query("select * from order_detail_user");
                                        ...
                                        <tr>
                                            <!--<td >
                                                <div class="info"><?php //echo $exe_ord['C_city']; ?></div>
                                                
                                            </td>-->
											<td><?php echo $exe_ord['O_Id'];?></td>
											<td><?php echo $exe_ord['P_Name'];?></td>
											<td><?php echo $exe_ord['P_Price'];?></td>
											<td><?php echo $exe_ord['P_Quantity']; ?></td>
                                            <td><?php echo $exe_ord['C_Name']; ?></td>											
                                            <td><?php echo $exe_ord['T_Amount']; ?>
                                            <span class="label label-success label-mini"><a style="text-decoration:none;" href="display_orderlist.php?pay_sts=<?php echo $exe_ord['Id'];?>" ><?php echo $exe_ord['Pay_Status'];?></a> 
											</span>
											</td>
											
											<td>
											<span class="label label-success label-mini"><a style="text-decoration:none;" href="display_orderlist.php?sts_ord=<?php echo $exe_ord['Id'];?>" ><?php echo $exe_ord['Order_Status'];?></a>
											</span>
											</td>
                                            <td><?php echo $exe_ord['C_Address'];?></td>    
                                            
                                            <!--<td><a href="display_orderlist.php?sts_id=<?php //echo $exe_ord['Id']; ?>"  name="sub_osts"></a></td>-->
											<td><?php echo $exe_ord['paymentMethod'];?></td>
