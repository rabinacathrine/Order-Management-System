         ...
         <!-- BEGIN SIDEBAR MENU -->
          <ul class="sidebar-menu">
              ...
              <li class="has-sub">
				...
				<li class="has-sub">
					<a href="javascript:;" class="">
					    <span class="icon-box"> <i class="icon-book"></i></span>Stock
					    <span class="arrow"></span>
					</a>
					<ul class="sub">
						<li><a class="" href="#">Add Deatail</a></li>
						<li><a class="" href="#">Discount & Scheme</a></li>
					</ul>
				</li>
              <li class="has-sub">
                  <a href="javascript:;" class="">
              ...
              <li class="has-sub active">
                  ...
                  <ul class="sub">
                      <li class="active"><a class="" href="sidebar_closed.php">Sidebar Closed Page</a></li>
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                   ...
                   <h3 class="page-title">
                     Sidebar Closed Page
                     <small>sidebar closed page sample</small>
                  </h3>
                   <ul class="breadcrumb">
                       <li>
