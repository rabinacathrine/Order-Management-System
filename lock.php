...
<body id="lock-body">
  ...
  <div id="lock">
    <!-- BEGIN LOCK FORM -->
    <form id="lockform" class="form-vertical no-padding no-margin" action="index.php">
      <div class="lock-title">
          <i class="icon-lock"></i>
          <h3>Locked</h3>
      </div>
      <div class="lock-avatar-row">
          <img src="img/DSC_0006.JPG" alt="">
      </div>
      <div class="control-wrap lock-identity">
          <h3><?php echo $_SESSION['usr'];?></h3>
          ...
          <div class="lock-form-row">
              <form action="index.php" class="form-search">
                  ...
                  <div class="relogin">
                      <a href="index.php">Not Dulal Khan ?</a>
                  </div>
              </form>
          </div>
      </div>
