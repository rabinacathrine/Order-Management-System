...
?>
<?php
	if(isset($_REQUEST['s_st']))
	{
		$st_id=$_REQUEST['s_st'];
		$sel_st=mysql_query("select * from supplier where S_Id='$st_id'");
		$ft_st=mysql_fetch_array($sel_st);
		if($ft_st['S_status']=='enable')
		{
			$up_st=mysql_query("update supplier set S_status='disable' where S_Id='$st_id'");
			header("location:supplier_detail.php");
		}
		else
		{
			$up_st=mysql_query("update supplier set S_status='enable' where S_Id='$st_id'");
			header("location:supplier_detail.php");
		}
	}
?>
               ...
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
                           <a href="#">Supplier</a> <span class="divider">&nbsp;</span>
                       </li>
                       <li><a href="#">Supplier detail</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                  ...
                  <div class="widget">
                       <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-tags"></i> Supplier Detail List</h4>
                                        <span class="tools">
                                ...
                                <div class="widget-body">
								    ...
								    <table class="table table-striped table-bordered table-advance table-hover" border="1">
                                        <thead>
                                        <tr>
                                            <th><i class="icon-leaf"></i> <span class="hidden-phone">S_Id</span></th>
											<th><span>Supplier Name</span></th>
											<th><span>Supplier Email</span></th>
											 <th><i class="icon-user"></i> <span class="hidden-phone ">Supplier Contact</span></th>
											 <th>Supplier Address</th>
											<th><span>Supplier City</span></th>
											<th><span>Supplier State</span></th>
                                        ...
                                        <tbody>
										<?php 
											$sel_prod=mysql_query("select * from  supplier  ");
											while($exe_prod=mysql_fetch_array($sel_prod))
											{
										?>
                                        <tr>
                                            <td >
                                                <div class="info"><?php echo $exe_prod['S_Id']; ?></div>
                                                
                                            </td>
											<td><a href="supplier_p_detail.php?snm=<?php echo $exe_prod['S_Id'];?>" ><?php echo $exe_prod['S_UserName']; ?></td>
											<td><?php echo $exe_prod['S_Email'];?></td>
											 <td><?php echo $exe_prod['S_MoNo']; ?></td>
											 <td><?php echo $exe_prod['S_Address'];?></td>
											<td><?php echo $exe_prod['S_City'];?></td>
											<td><?php echo $exe_prod['S_State'];?></td>
											<td><a href="supplier_detail.php?s_st=<?php echo $exe_prod['S_Id'];?>" ><?php echo $exe_prod['S_status'];?></a></td>
