                       ...
                       <div class="widget">
                                ...
                                <div class="widget-body">
                                    <table class="table table-striped table-bordered table-advance table-hover" border="1">
                                        <thead>
                                        <tr>
                                            <th><i class="icon-leaf"></i> <span class="hidden-phone">P_Id</span></th>
                                        ...
                                        <tbody>
										<?php 
											$sel_prod=mysql_query("select * from addproduct join supplier on addproduct.S_Id=supplier.S_Id  ");
											while($exe_prod=mysql_fetch_array($sel_prod))
											{
										?>
                                        <tr>
                                            <td >
                                                <div class="info"><?php echo $exe_prod['P_Id']; ?></div>
                                                
                                            </td>
											<td><?php echo $exe_prod['P_Name'];?></td>
											<td><?php echo $exe_prod['P_Price'];?></td>
											<td><?php echo $exe_prod['PS_Price'];?></td>
